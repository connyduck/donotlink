...
<body><p>Redirecting to <a rel="nofollow" href="<?php echo htmlspecialchars($url, ENT_COMPAT | ENT_HTML5, "UTF-8", false); ?>"><?php echo htmlspecialchars($url, ENT_COMPAT | ENT_HTML5, "UTF-8", false); ?></a></p></body></html>
